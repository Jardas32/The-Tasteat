...
let card = {idcard, imges, title, pricenumber, opisanie, btaddcart};     
...
document.querySelectorAll(`.cards`).forEach(el => {
 ...
 openpopup.addEventListener(`click`, function() {
    ...
    // const img = this.getAttribute("data-imgpopup");
    // const title = this.getAttribute("data-titlepopup");
    // const opisanie = this.getAttribute("data-opisaniepoup");
